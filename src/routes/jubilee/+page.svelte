	...
	onMount(() => {
		inView('section', ({ target }) => {
			...
			animate(
				...
				{ x: ['200%', '-125%'] },
				{ duration: 5, delay: 2.5, repeat: Infinity }
			);
		});
	});
</script>
...
<section class="relative h-[100dvh] w-[100dvw] flex justify-center items-center">
	...
	<div class="absolute w-100cqw top-10 z-3" id="flight">
		<img
			class="object-contain w-[35%] overflow-hidden"
	...
	<div class="absolute h-[100dvh] w-[100dvw] flex justify-between z-1">
		...
		>
			торжественные мероприятия приуроченные к столетнему<br />
			юбилею Брониславы<br />
			Анатольевны<br />
			Дубнер<br />
			(урожденной<br />
			Гусевой),<br />
	...
	<div class="absolute w-100cqw mt-170 flex justify-end" id="light">
		<img
			class="object-contain w-[35%] overflow-hidden"
